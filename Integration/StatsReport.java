...
public class StatsReport extends JFrame {
	...
	public StatsReport() {
		...
		submitPanel.setBorder(padding);

		add(submitPanel);
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setTitle("Statistical Report"); // sets the title of the frame
