...
public class LabRecords {
  ...
  // Main class
  /////////////////////////////////////////////////////////////////
	JList<Records> recordList;
	JTextField firstNameField; // first name text field
  ...
  public LabRecords() {
	...
	final JTextArea labRecordArea = new JTextArea(15, 20); // Text area for upload lab records
	...
	//PATIENT LIST
	patientVector = new Vector<Patient>(); // Vector of Records objects
	...
	mainFrame = new JFrame("Lab Records");
	...
	JList<Patient> searchList = new JList<Patient>(searchVector);
