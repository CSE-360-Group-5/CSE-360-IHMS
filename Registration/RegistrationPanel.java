  ...
  private static final long serialVersionUID = 1L;
	...
	public RegistrationPanel()
	{
	  ...
	  /////////////////////////////////////////////////////////////////
		...
		//Radio Buttons
		male = new JRadioButton("Male", true); //male option for sex radio button
		...
		single = new JRadioButton("Single", true); //single option
			...
			if(action == submitButton)
			{
				...
				else if (typeDropdown.getSelectedIndex() == 1)
				{
					try
					{
			            ...
			            id++;
						statement = conn.createStatement();
						statement.executeUpdate("INSERT INTO patient (idpatient, fname, lname, dob, email, password, sex, medHistory, mstatus, education, race)" + "VALUES (" + id + ", '" + firstName + "', '" + lastName + "', '" + dob + "', '" + emailAddress + "', '" + password + "', '" + sex + "', '" + medicalHistory + "', '" + mStatus + "', '" + eLVL + "', '" + pRace + "')");
