...
public class CalendarProgram{
	...
	static String[] input(int d, int m, int y){//input frame for schedule
		...
		JLabel doctor=new JLabel("Choose your Doctor:"), day=new JLabel(Integer.toString(d)), da= new JLabel("Date:"),mo=new JLabel("Month:"), month=new JLabel(Integer.toString(m));
		JLabel ye= new JLabel("Year:"), year=new JLabel(Integer.toString(y)),time= new JLabel("Appointment Time:");
